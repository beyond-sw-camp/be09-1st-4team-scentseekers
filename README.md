...
장호정
ㄴ 팀원1: 창의적인 아이디어를 제시해주어 프로젝트의 주제를 정하고 큰 틀을 만드는데 기여해주셨고 바커표기법을 이용한 논리 모델링을 잘 작성해주셨습니다!
...
ㄴ 팀원2: 이해가 잘 안 가는 사항이나 헷갈리는 것을 여쭤보면 언제나 친절하게 알려주셨고, 프로젝트를 리더처럼 이끌어 가셨습니다.
...
ㄴ 팀원5: 해결이 어려운 문제를 마주치면 해결할 수 있는 방안을 빠르게 생각해내셨고, 한참 끙끙대고 있을 때 도움을 주셨습니다.
...
노다민
ㄴ 팀원1: 발표할 때 질문에 대한 방어를 너무 잘 해주셨고, 상황에 대한 이해가 빠르셔서 지금 해야 할 것을 빠르게 캐치하셨습니다.
...
ㄴ 팀원5: 모델링 과정에서 문제가 될 수 있는 사항과 해결 방안을 깊게 고민해 주셨고, 팀에 협력하려는 태도가 매우 좋으셨습니다.
...
윤채연
ㄴ 팀원1: 처음 주제를 정한 후 좋은 아이디어를 많이 제시해 주셨습니다. 중간 발표 때 프로젝트 소개 및 주요 기능 부분을 잘 발표해주셨고 좋은 결과를 얻게 된 것 같습니다. 마지막으로 ppt를 직접 제작하셨는데, ppt를 이렇게까지 잘 만들 수 있는지 처음 알게되었습니다!
...
ㄴ 팀원5: 발표 ppt를 너무 예쁘게 잘 만드셨고, 항상 빛나는 아이디어를 내셔서 프로젝트 기획이 순조롭게 진행되도록 해주셨습니다.
